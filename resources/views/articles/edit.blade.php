                    ...
                    <form action="{{ route('articles.update', $article->id) }}" method="POST">
                        ...
                        <div>
                            <div class="mb-3">
                                ...
                                <div class="my-3">
                                    <input value="{{ old('author',$article->author) }}" type="text" name="author" class="border-gray-300 shadow-sm w-1/2 rounded-lg" placeholder="Author">
                                    @error('author')
                                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                    @enderror
                                </div>
                                <button class="bg-blue-700 text-sm rounded-md px-5 py-3 text-white ">Update</button>
                            </div>
                        </div>
                    </form>
                </div>
